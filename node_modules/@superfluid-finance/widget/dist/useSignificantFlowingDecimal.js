...
export const useSignificantFlowingDecimal = (flowRate, animationStepTimeInMs) => useMemo(() => {
    if (flowRate === 0n) {
        return undefined;
    }
    ...
    const isFlowingInWholeNumbers = absoluteValue(BigInt(beforeEtherDecimal)) > 0n;
