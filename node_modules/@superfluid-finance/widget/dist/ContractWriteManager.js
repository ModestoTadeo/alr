...
export function ContractWriteManager({ prepare: _prepare, contractWrite: contractWrite_, onChange, }) {
    ...
    const prepare = accountAddress && _prepare && contractWrite.chainId === chain?.id;
    ...
    const writeResult = useContractWrite({
        ...(prepare
            ? prepareResult.isError
                ? {
                    ...
                    request: {
                        ...
                        gas: 2500000n, // Set _some_ kind of a limit more reasonable than the default 28_500_000.
                    },
                }
            ...
            : {}),
        onError: console.error,
        onSuccess: ({ hash }) => eventHandlers.onTransactionSent?.({
            hash,
            functionName: contractWrite.functionName,
        }),
    });
    ...
    const result = useMemo(() => {
        if (writeResult.isError &&
            ...
            if (writeResult.error.cause instanceof UserRejectedRequestError ||
