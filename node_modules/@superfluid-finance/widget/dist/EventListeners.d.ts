...
export type TxFunctionName = ExtractAbiFunctionNames<typeof cfAv1ForwarderABI, "nonpayable" | "payable">;
/**
...
export interface EventListeners {
    ...
    onRouteChange?: (props?: {
        route: "step_payment_option" | "step_wrap" | "step_review" | "step_personal_data" | "transactions" | "success_summary";
        data?: Record<string, string>;
    }) => void;
    /** Called when any personalData fields update. */
    onPersonalDataUpdate?: (props?: {
        data?: Record<string, string>;
    }) => void;
 ...
 */
export declare const runEventHandlers: <T, R = void>(listener?: (args?: T) => R, callback?: (args?: T) => R) => (arg?: T) => void;
